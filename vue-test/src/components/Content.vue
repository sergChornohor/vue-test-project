<template>
  <div class="content-container flex justify-center">
    <div class="content-container-data flex space-between align-center">
      <div class="date">
        <h6>{{date}}</h6>
      </div>
      <div class="content-container-data-posts" id="posts" v-if="!isHidden">
      ...
      <div class="post flex space-between comment">
        ...
        <div class="post felx  space-between upload">
          ...
          <div class="uploaded-photos flex">
            <div class="uploaded-photo" @click="getNotifications(index)"></div>
            <div class="uploaded-photo" @click="getNotifications(index)"></div>
            <div class="uploaded-photo" @click="getNotifications(index)"></div>
            <div class="uploaded-photo" @click="getNotifications(index)"></div>
          </div>
